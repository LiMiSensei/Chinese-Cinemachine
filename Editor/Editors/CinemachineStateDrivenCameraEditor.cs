...
namespace Unity.Cinemachine.Editor
{
    ...
    class CinemachineStateDrivenCameraEditor : CinemachineVirtualCameraBaseEditor
    {
        ...
        protected override void AddInspectorProperties(VisualElement ux)
        {
            ...
            var noTargetHelp = ux.AddChild(new HelpBox("需要一个动画目标", HelpBoxMessageType.Warning));
            ...
            FormatInstructionElement(true,
                header.AddChild(new Label("状态")),
                header.AddChild(new Label("相机")),
                header.AddChild(new Label("等待")),
                header.AddChild(new Label("最小")));
