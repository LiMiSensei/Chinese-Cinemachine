...
namespace Unity.Cinemachine.Editor
{
    ...
    class CinemachineGroupFramingEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var groupSizeIsZeroHelp = ux.AddChild(new HelpBox("组大小为零，无法构图。", HelpBoxMessageType.Warning));

            ux.Add(new PropertyField(serializedObject.FindProperty(() => Target.FramingMode),"构图模式"));
            ux.Add(new PropertyField(serializedObject.FindProperty(() => Target.FramingSize),"构图尺寸"));
            ux.Add(new PropertyField(serializedObject.FindProperty(() => Target.CenterOffset),"中心偏移"));
            ux.Add(new PropertyField(serializedObject.FindProperty(() => Target.Damping),"阻尼"));
