...
namespace Unity.Cinemachine.Editor
{
    ...
    class CinemachineStoryboardEditor : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var row = ux.AddChild(new InspectorUtility.LabeledRow("显示图像", showImageProp.tooltip));
            ...
            waveformRow.Left.Add(new Label("波形监视器"));
            waveformRow.Right.AddChild(new Button(() => WaveformWindow.OpenWindow()) { text ="打开", style = { flexBasis = 100 }});

            // Advanced
            var advanced = ux.AddChild(new Foldout() { text = "高级", value = s_AdvancedFoldout });
