...
namespace Unity.Cinemachine.Editor
{
    ...
    {
        const string k_NeedTarget = "Cinemachine相机需要一个跟踪目标。";
        const string k_NeedLookAt = "Cinemachine相机需要一个看向目标。";
        const string k_NeedGroupTarget = "Cinemachine相机中的跟踪目标必须是一个目标组。";
        const string k_NeedGroupLookAt = "Cinemachine相机中的看向目标必须是一个目标组。";
        const string k_NeedCamera = "此组件仅适用于Cinemachine相机。";
        const string k_AddCamera = "添加Cinemachine相机";
        const string k_DuplicateComponent = "此组件重复，将被忽略。";
