...
namespace Unity.Cinemachine.Editor
{
    static class CinemachineMenu
    {
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "Cinemachine 相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "目标相机/跟随相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "目标相机/2D 相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "目标相机/自由视角相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "目标相机/第三人称瞄准相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "目标相机/目标组相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "序列相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "状态驱动相机", false, m_GameObjectMenuPriority)]
...
#if CINEMACHINE_PHYSICS
        [MenuItem(m_CinemachineGameObjectRootMenu + "清晰视角相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "混合相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "样条轨道相机", false, m_GameObjectMenuPriority)]
        ...
        [MenuItem(m_CinemachineGameObjectRootMenu + "样条轨道小车", false, m_GameObjectMenuPriority)]
